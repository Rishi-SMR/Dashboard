...
//
// The three live accounts in `dashboard_users` are all finance/ops, so all three
// are admins. NONE of the four reps has a login yet — add them below (or in
// app_config) as they are provisioned.
//
...
export const REP_DIRECTORY = [
  ...
  // Rep logins — fill in the address as each is created. repName must stay
  // exactly as spelled in REP_NAMES above.
  // { email: '…@sportsmedrecovery.com', repName: 'Alle Ann', role: 'rep' },
  // { email: '…@sportsmedrecovery.com', repName: 'Jillian',  role: 'rep' },
  // { email: '…@sportsmedrecovery.com', repName: 'Cassie',   role: 'rep' },
  // { email: '…@sportsmedrecovery.com', repName: 'Christy',  role: 'rep' },
];
